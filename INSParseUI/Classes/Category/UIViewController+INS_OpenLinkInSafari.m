//
//  UIViewController+INS_OpenLinkInSafari.m
//  INSParseUI
//
...
- (void)ins_openLinkInSafari:(NSString *)linkString {
    ...
    if ([shareUrlString jk_isValidUrl]) {
        ...
        [alert ins_showErrorOnMostTopViewControllerWithTitle:@"非法的URL地址" subTitle:@"请确认您的链接地址后重试！" closeButtonTitle:@"确认" duration:0.0f];
    }
}
