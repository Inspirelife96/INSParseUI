...
@implementation INSParseErrorHandler
...
+ (void)_handleError:(NSError *)error {
    ...
    [alertView ins_showErrorOnMostTopViewControllerWithTitle:@"出错啦" subTitle:[INSParseErrorHandler errorMessage:error.code] closeButtonTitle:@"好的" duration:0.0];
}
