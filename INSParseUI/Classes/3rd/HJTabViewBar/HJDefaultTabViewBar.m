...
- (void)setBadgeValue:(NSString *)badgeValue forIndex:(NSInteger)index {
    ...
    button.jk_badgeValue = badgeValue;
    
    button.jk_badgeBGColor   = [UIColor redColor];
    button.jk_badgeTextColor = [UIColor whiteColor];
    button.jk_badgeFont      = [UIFont systemFontOfSize:10.0];
    button.jk_badgePadding   = 3;
    button.jk_badgeMinSize   = 6;
    button.jk_badgeOriginX   = button.frame.size.width - button.jk_badge.frame.size.width;
    button.jk_badgeOriginY   = 0;
    button.jk_shouldHideBadgeAtZero = YES;
    button.jk_shouldAnimateBadge = YES;
}
