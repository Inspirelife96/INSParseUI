...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/HJTabViewController/HJTabViewController.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/INSParse/INSParse.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/INSParseUI/INSParseUI.framework"
