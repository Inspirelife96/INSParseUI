...
static CGFloat const kCommentTextViewHeight = 189.0;
...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        [frameworkBundle loadNibNamed:@"CLTextView" owner:self options:nil];
...
- (void)textViewDidChange:(UITextView *)textView {
    ...
    self.textNumberLabel.textColor = [UIColor grayColor];
...
- (void)setMaxNumberWords:(NSInteger)maxNumberWords {
    ...
    self.textNumberLabel.text = [NSString stringWithFormat:@"0/%ld", maxNumberWords];
}
