...
@implementation INSDropdownMenuCell
...
- (MKDropdownMenu *)dropdownMenu {
    if (!_dropdownMenu) {
        ...
        _dropdownMenu.backgroundDimmingOpacity = -0.67;
        _dropdownMenu.dropdownShowsTopRowSeparator = NO;
        _dropdownMenu.dropdownBouncesScroll = NO;
        _dropdownMenu.rowSeparatorColor = [ThemeManager colorFor:@"INSDropdownMenu.dropdownMenu.rowSeparatorColor"];
        ...
        _dropdownMenu.disclosureIndicatorImage = [UIImage imageNamed:@"dropdownMenu"];
